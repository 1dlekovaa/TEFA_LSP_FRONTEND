...
<template>
  <div class="space-y-6">
    ...
    <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <DashboardCard title="Jumlah Asesi" :value="stats.asesi" type="asesi" />
      <DashboardCard
        title="Jumlah Asesor"
        :value="stats.asesor"
        type="asesor"
      />
      <DashboardCard title="Jumlah Pengguna" :value="stats.user" type="user" />
      <DashboardCard title="Jumlah Skema" :value="stats.skema" type="skema" />
    </div>
  </div>
</template>
