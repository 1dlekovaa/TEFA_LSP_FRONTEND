    ...
    <table>
      ...
      <tbody>
        <tr v-for="(item, index) in paginatedData" :key="item.id">
          ...
          <td>
            <button class="btn-blue">Daftar Asesi</button>
            <button class="btn-orange">Daftar Test</button>
          </td>
        </tr>
      </tbody>
    </table>
...
th,
td {
  border: 1px solid #ccc; /* garis antar kolom & baris */
  padding: 10px;
  text-align: center;
}

thead tr {
  border-bottom: 2px solid #999; /* garis header lebih tebal */
}
